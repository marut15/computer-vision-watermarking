...
Outputs:
  - decoding/results/per_bit_branch_compare.json
  - decoding/results/figures/per_bit_branch_compare.png

Usage:
  python decoding/scripts/per_bit_branch_compare.py \
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-json", default=str(DECODING_ROOT / "results" / "per_bit_branch_compare.json"))
    p.add_argument("--out-fig", default=str(DECODING_ROOT / "results" / "figures" / "per_bit_branch_compare.png"))
    return p.parse_args()
