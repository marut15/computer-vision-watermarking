...
Outputs:
  - decoding/results/radial_ablation.json
  - decoding/results/figures/radial_ablation.png

Usage:
  python decoding/scripts/radial_ablate_spectral.py \
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-json", default=str(DECODING_ROOT / "results" / "radial_ablation.json"))
    p.add_argument("--out-fig", default=str(DECODING_ROOT / "results" / "figures" / "radial_ablation.png"))
    return p.parse_args()
