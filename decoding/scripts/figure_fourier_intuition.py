...
Usage:
  python decoding/scripts/figure_fourier_intuition.py
  python decoding/scripts/figure_fourier_intuition.py --prompt-id 3
  python decoding/scripts/figure_fourier_intuition.py --fft-crop 0   # full spectrum
  python decoding/scripts/figure_fourier_intuition.py \\
...
def baseline_for_prompt(baseline_dir: Path, prompt_idx: int) -> Path | None:
    """Mirrors decoding/scripts/bit_difference_viewer.py path resolution."""
    candidates = [
