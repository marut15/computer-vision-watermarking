...
# training/train.py and the YAML configs under decoding/configs/.
#
...
#   bash decoding/training/jobs/train_new_decoders.sh --force
#   bash decoding/training/jobs/train_new_decoders.sh --skip-global-stats --skip-spectral
#   bash decoding/training/jobs/train_new_decoders.sh --smoke      # 2-epoch run on the synthetic fixture
...
mkdir -p "${LOG_DIR}" "${DECODING}/checkpoints"
