...
Usage
-----
    python evaluation/scripts/figures/paper_diagnostic_figures.py \\
...
# ── path setup ────────────────────────────────────────────────────────────────
HERE         = Path(__file__).resolve().parent   # evaluation/scripts/figures/
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--output-dir",   default=str(REPO_ROOT / "evaluation" / "results" / "figures"))
