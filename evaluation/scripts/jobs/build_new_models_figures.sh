...
#
# Outputs:
#   evaluation/results/training_logs/<arch>.log         (training, force-added)
#   evaluation/results/training_logs/<arch>.eval.log    (clean eval, force-added)
#   evaluation/results/training_logs/<arch>.robust.log  (robustness eval, force-added)
...
#
# Usage:
#   bash evaluation/scripts/jobs/build_new_models_figures.sh
#   bash evaluation/scripts/jobs/build_new_models_figures.sh --no-commit  # figures only
#   bash evaluation/scripts/jobs/build_new_models_figures.sh --branch main
...
OLD_RESULTS="${REPO}/evaluation/results/metrics"
...
LOG_STAGING="${REPO}/evaluation/results/training_logs"
mkdir -p "${LOG_STAGING}"
...
"${PYTHON}" "${EVAL_SCRIPTS}/figures/build_new_models_figures.py" \
...
evaluation/results/training_logs/ so they're available in the repo for
