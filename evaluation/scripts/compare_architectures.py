...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--report-md", type=str, default=str(REPO_ROOT / "evaluation" / "reports" / "architecture_comparison.md"))
    p.add_argument("--chart-png", type=str, default=str(REPO_ROOT / "evaluation" / "results" / "figures" / "architecture_comparison.png"))
