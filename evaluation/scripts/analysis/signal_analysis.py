...
Four diagnostics, all writing PNGs into ``evaluation/results/figures/``:
...
from decoding.common.smoke import default_data_paths, pick_device, resolve_paths, ensure_smoke_fixture
