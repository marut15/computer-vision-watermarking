...
Outputs:
  - evaluation/results/metrics/cepstrum.json   (top peaks + summary stats)
  - evaluation/results/figures/cepstrum_delta.png  (heatmaps)
...
Usage:
  python evaluation/scripts/analysis/cepstrum_delta.py
"""
...
def parse_args():
    ...
    p.add_argument("--out-json", default=str(REPO_ROOT / "evaluation" / "results" / "metrics" / "cepstrum.json"))
    p.add_argument("--out-fig", default=str(REPO_ROOT / "evaluation" / "results" / "figures" / "cepstrum_delta.png"))
    return p.parse_args()
