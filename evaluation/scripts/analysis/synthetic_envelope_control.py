...
Outputs:
  - evaluation/results/figures/synthetic_envelope_control.png
  - evaluation/results/metrics/synthetic_envelope_control.json

Usage:
  python evaluation/scripts/analysis/synthetic_envelope_control.py
  python evaluation/scripts/analysis/synthetic_envelope_control.py --gain 0.15 --k0 60
"""
...
def parse_args():
    ...
    p.add_argument("--out-fig", default=str(REPO_ROOT / "evaluation" / "results" / "figures" / "synthetic_envelope_control.png"))
    p.add_argument("--out-json", default=str(REPO_ROOT / "evaluation" / "results" / "metrics" / "synthetic_envelope_control.json"))
    return p.parse_args()
