...
Outputs:
  - evaluation/results/metrics/delta_dataset.json  (all stats, indexed by entry)
  - evaluation/results/figures/delta_dataset/
...
Usage:
  python evaluation/scripts/analysis/delta_dataset_analysis.py
  python evaluation/scripts/analysis/delta_dataset_analysis.py --prompt-ids 0,1,2
  python evaluation/scripts/analysis/delta_dataset_analysis.py --fft-size 256
...
def main() -> None:
    ...
    out_json = Path(args.out_json) if args.out_json else REPO_ROOT / "evaluation" / "results" / "metrics" / "delta_dataset.json"
    out_fig = Path(args.out_fig_dir) if args.out_fig_dir else REPO_ROOT / "evaluation" / "results" / "figures" / "delta_dataset"
