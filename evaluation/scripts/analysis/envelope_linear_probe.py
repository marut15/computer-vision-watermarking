...
Outputs:
  - evaluation/results/metrics/envelope_linear_probe.json
  - evaluation/results/figures/envelope_linear_probe.png

Usage:
  python evaluation/scripts/analysis/envelope_linear_probe.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-json", default=str(REPO_ROOT / "evaluation" / "results" / "metrics" / "envelope_linear_probe.json"))
    p.add_argument("--out-fig", default=str(REPO_ROOT / "evaluation" / "results" / "figures" / "envelope_linear_probe.png"))
    return p.parse_args()
...
def main() -> None:
    ...
    # evaluation/results/metrics/dual_branch_r50.md (no_spatial mode).
