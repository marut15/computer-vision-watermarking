...
Usage:
  python evaluation/scripts/analysis/synthetic_broadband_control.py
  python evaluation/scripts/analysis/synthetic_broadband_control.py --image path/to/baseline.png
  python evaluation/scripts/analysis/synthetic_broadband_control.py --epsilon 0.05

Outputs:
  - evaluation/results/figures/synthetic_broadband_control.png
  - evaluation/results/metrics/synthetic_broadband_control.json (numerical summary)
"""
...
def parse_args():
    ...
    p.add_argument("--out-fig", default=str(REPO_ROOT / "evaluation" / "results" / "figures" / "synthetic_broadband_control.png"))
    p.add_argument("--out-json", default=str(REPO_ROOT / "evaluation" / "results" / "metrics" / "synthetic_broadband_control.json"))
    return p.parse_args()
